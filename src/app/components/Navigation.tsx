      ...
      <div className="max-w-6xl mx-auto px-6 py-3">
        <div className="flex items-center justify-between">
          <a href="#" className="text-lg font-semibold flex items-center gap-2">
            <span className="text-foreground">mbchavezz</span>
          </a>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#skills" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors duration-200">
              Skills
            </a>
            <a
              href="#projects"
            ...
            <a href="#awards" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors duration-200">
              Awards
            </a>
        ...
        {isOpen && (
          <div className="md:hidden flex flex-col gap-4 py-6">
            ...
            <a href="#awards" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
              Awards
            </a>
